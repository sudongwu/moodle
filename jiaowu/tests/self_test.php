...
class enrol_jiaowu_testcase extends advanced_testcase {

    public function test_basics() {
        $this->assertTrue(enrol_is_enabled('self'));
        $plugin = enrol_get_plugin('jiaowu');
        $this->assertInstanceOf('enrol_jiaowu_plugin', $plugin);
        $this->assertEquals(1, get_config('enrol_jiaowu', 'defaultenrol'));
        $this->assertEquals(ENROL_EXT_REMOVED_KEEP, get_config('enrol_jiaowu', 'expiredaction'));
    }
    ...
    public function test_longtimnosee() {
        ...
        $trace->reset_buffer();
        $this->assertEquals(10, $DB->count_records('user_enrolments'));
        $this->assertStringContainsString('No expired enrol_jiaowu enrolments detected', $output);
    ...
    public function test_send_expiry_notifications() {
        ...
        /** @var $selfplugin enrol_jiaowu_plugin */
    ...
    public function test_can_self_enrol() {
        ...
        $expectederrorstring = get_string('canntenrol', 'enrol_jiaowu');
    ...
    /**
     * Test enrol_jiaowu_check_group_enrolment_key
     */
    public function test_enrol_jiaowu_check_group_enrolment_key() {
        global $DB;
        ...
        $result = enrol_jiaowu_check_group_enrolment_key($course->id, 'invalidpassword');
        $this->assertFalse($result);

        $result = enrol_jiaowu_check_group_enrolment_key($course->id, 'thepassword');
        ...
        $result = enrol_jiaowu_check_group_enrolment_key($othercourse->id, 'thepassword');
        $this->assertFalse($result);
    ...
    public function test_get_welcome_email_contact() {
        ...
        assign_capability('enrol/jiaowu:holdkey', CAP_ALLOW, $managerrole->id, $context);
